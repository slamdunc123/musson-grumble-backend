...
$sql = "SELECT recipes.id as id, recipes.name as name, recipes.category_id as c_id, recipes.description as description, recipes.ingredients as ingredients, recipes.instructions as instructions, recipes.suggestions as suggestions, categories.name as c_name FROM recipes, categories WHERE recipes.category_id = categories.id ORDER BY name ASC";
